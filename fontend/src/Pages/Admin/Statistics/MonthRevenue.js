...
const MonthRevenue = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'Profit',
      render: (record) => {
        const totalPurchasePrice = record.totalPurchasePrice;
        const totalRevenue = record.totalRevenue;
        const Rofit = totalRevenue - totalPurchasePrice;
        const format = Rofit.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })
        return <p>{format}</p>
      }
    },
    {
  ...
  const columnsDetail = [
    ...
    },
    {
      ...
      render: (record) => {
        ...
        const Format =  Profit.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })
        return  <p>{Format}</p>
      }
    ...
    const  data = res.data.map(item => (
      {
          ...
          'Tiền hàng': item.totalPurchasePrice,
